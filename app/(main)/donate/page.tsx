      ...
      <section className="px-45 py-57 flex flex-col gap-8 items-start justify-center border-y border-y-grey-300 bg-[linear-gradient(0deg,rgba(17,17,17,0.2),rgba(17,17,17,0.2)),linear-gradient(267.06deg,rgba(255,92,0,0.21)_23.55%,rgba(17,17,17,0.3)_64.33%)] backdrop-blur-[100px]">
        ...
        <div className="max-w-309">
          <h1 className="text-[2.5rem] text-white uppercase font-[700] tracking-[-0.03em]">
            Donate to&nbsp;
            <br /><span className="text-stc-200">Abuja Blazers</span>
          </h1>
        </div>
        <p className="max-w-419 font-button text-grey-25">
          Help us grow flag football in Nigeria. Every donation supports player <br></br>development, equipment, and community
          programs.
        </p>
      </section>
        ...
        <div className="grid grid-cols-[1.5fr_588px] gap-20">
          <div className="flex flex-col gap-20">
            ...
            <form className="rounded-2xs py-30 px-10 bg-[#181818] flex flex-col gap-20">
              <h1 className="py-10 border-b border-b-grey-300 font-title uppercase text-grey-200 font-satoshi">Select donation amount</h1>
              ...
              <button type="submit" className="btn btn-primary bg-stc-200 py-10 rounded-[5px] text-grey-400 hover:text-grey-400/90 uppercase font-title font-satoshi text-2xl">Complete donation</button>
            </form>
          </div>
          ...
          <div className="flex flex-col gap-20">
            <div className="rounded-2xs border-[0.5px] border-stc-200 bg-grey-500">
                <div className="py-29 px-34 flex flex-col gap-10 divide-y divide-grey-300 [&>*:first-child]:border-t-0">
                    ...
                    <div className="py-19.5 flex justify-between items-center">
                        ...
                        <h4 className="text-grey-200 font-title uppercase">
                            OPAY
                        </h4>
                    </div>
                    <div className="py-19.5 flex justify-between items-center">
                        <p className="font-label tracking-normal uppercase text-grey-25">Account name</p>
                        <h4 className="text-grey-200 font-title">
                            Abuja Blazers Football Ventures
                        </h4>
                    </div>
                    <div className="py-19.5 flex justify-between items-center">
            ...
            <InfoCard
                ...
                description={<span className="font-inherit">After making your transfer, please send a screenshot of your payment confirmation to <a href="mailto:donations@abujablazers.ng" className="text-stc-200">donations@abujablazers.ng</a>so we can acknowledge your contribution and issue a receipt.</span>}
            />
...
const supportInfo = [
  { icon: <Image src={Football} alt="" width={24} className="h-auto object-cover" />, title: "Equipment", description: "Fund jerseys, flags, and training gear for the team" },
  { icon: <Running className="size-24 text-stc-200" />, title: "Youth Program", description: "Support free training camps for young athletes in Abuja" },
  { icon: <Image src={Facilties} alt="" width={24} className="h-auto object-cover" />, title: "Facilities", description: "Help us secure better training grounds and venues" },
];
            ...
            <span className="font-title-lg tracking-normal font-medium uppercase flex gap-[0.25em]">
                {words.map((word, i) => (
                    <span
                        ...
                        style={{
                            transition: animate ? `transform 250ms cubic-bezier(0.34, 1.56, 0.64, 1) ${i * 60}ms, opacity 200ms ease ${i * 60}ms` : "none",
...
const InfoCard = ({
    ...
    return (
        <div className="py-29 px-34 rounded-2xs flex flex-col gap-10 border border-grey-300 bg-grey-400">
            <p className="py-10 font-title font-satoshi text-stc-200 uppercase tracking-normal leading-none">
                {title}
            </p>
