                    ...
                    <div className="rounded-2xs border-[0.5px] border-stc-200 bg-grey-500">
                      <div className="px-34 py-29 flex flex-col gap-20">
                            <div className="border-b-[.6px] border-b-grey-300">
                                <h1 className="font-title font-satoshi uppercase text-grey-200">
                                    Your Tickets
                                </h1>
                            </div>
                            <div className="border-b-[.6px] border-b-grey-300 flex flex-col gap-10">
                                <h1 className="font-title font-satoshi text-grey-200">
                                    Vikings vs Abuja Blazers
                                </h1>
                                <p className="font-label tracking-normal text-grey-25">
                                    Qty: 1
                                </p>
                                <div className="flex justify-between items-center">
                                    <p className="font-title-lg font-bold tracking-normal text-stc-200">
                                        {formatCurrency(3000)}
                                    </p>
