                ...
                <div className="flex flex-col lg:flex-row gap-20 lg:items-center">
                    ...
                    <div className="flex gap-10 items-center">
                        {[
                            ...
                            <Link key={tab.href} href={`?status=${tab.href}`} scroll={false} className={clsx("btn rounded border border-grey-300 bg-grey-400 p-10 font-button uppercase", status === tab.href && " bg-stc-800 border-[.6px] border-stc-900 text-stc-200")}>
                                {tab.label}
                            </Link>
                        ))}
                    </div>
