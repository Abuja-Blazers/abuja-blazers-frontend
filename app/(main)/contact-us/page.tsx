        ...
        <div className="grid lg:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col gap-20">
            <ContactCard>
              ...
              <ContactCard.Items>
                <div className="py-18">
                  <p className="font-title font-satoshi text-grey-250">
                    General Inquiries & Sponsorship:
                    <span>
                      &nbsp;
                      <a className="text-stc-200 hover:text-stc-200/70" href="mailto:contact@abujablazers.com">
                        contact@abujablazers.com
                      </a>
                    </span>
                  </p>
                </div>
            ...
            <ContactCard>
              ...
              <ContactCard.Items>
                <ContactCard.Link
                  platform="Facebook"
                  handle="@abujablazersff"
                  href="https://www.facebook.com/people/Abujablazersff/61576337445464/#"
                />
                <ContactCard.Link
                  platform="Instagram"
                  handle="@abujablazersff"
                  href="https://instagram.com/abujablazersff"
                />
                <ContactCard.Link
                  platform="TikTok"
                  handle="@abujablazersff"
                  href="https://www.tiktok.com/@abujablazersff"
                />
                <ContactCard.Link
                  platform="Youtube"
                  handle="@abujablazersff"
                  href="https://www.youtube.com/@AbujaBlazersff"
                />
              </ContactCard.Items>
            </ContactCard>
            <Image
