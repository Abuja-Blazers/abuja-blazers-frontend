...
export default function FeaturedDrop({
    image, title, edition, price, description
}: { image: StaticImageData, title: string, edition: string, price: number, description: string }) {
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
                ...
                <div className="max-w-400 flex flex-col gap-30">
                    <div className="flex flex-col gap-10 lg:gap-0">
                        <p className="font-caption font-bold uppercase text-stc-200">
                            Featured Drop
                        </p>
