                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-20">
                        ...
                        <div className="flex flex-col gap-5">
                            <p className="text-grey-200 font-title-lg font-[900] tracking-normal capitalize">
                                {name}
                            </p>
                            <p className="text-grey-25 font-label tracking-normal uppercase">
                                {title}
                            </p>
                        </div>
                    </div>
                    <h1 className="font-inter font-bold text-[2.125rem] leading-none text-grey-350">
                        #{position}
                    </h1>
                </div>
            </div>
